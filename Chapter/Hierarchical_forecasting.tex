...
\begin{figure}[H]
	...
	\caption{Comparison of Naive vs Base forecasts using MSE}\label{NaiveVsBase_MSE}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Comparison of Naive vs Base forecasts using MASE}\label{NaiveVsBase_MASE}
\end{figure}
