...
\begin{figure}[!b]
	...
	\small
	\resizebox{\linewidth}{!}{
	\includegraphics[width=.9\textwidth]{Schematic_3D.pdf}
...
\end{align*}
\ref{fig:GDP_I} shows the full hierarchical structure capturing all components aggregated to form GDP using the income approach. The hierarchy has two levels of aggregation below the top-level, with a total of $n=16$ series across the whole structure and $m=10$ series at the bottom level.

\begin{figure}[!h]
	\centering
%	\includegraphics[width=.9\textwidth]{Figs/Hierarchical-structures/IncomeApproach.pdf}
	\includegraphics[width=.9\textwidth]{IncomeApproach.pdf}
...
%	\centering	\includegraphics[width=.9\textwidth]{Figs/Hierarchical-structures/ExpenditureApproach.pdf}
	\centering	\includegraphics[width=.9\textwidth]{ExpenditureApproach.pdf}
...
%	\includegraphics[width=.9\textwidth]{Figs/Hierarchical-structures/GFCF.pdf}
	\includegraphics[width=.9\textwidth]{GFCF.pdf}
...
%	\includegraphics[width=.9\textwidth]{Figs/Hierarchical-structures/HFCE.pdf}
	\includegraphics[width=.9\textwidth]{HFCE.pdf}
...
%	\includegraphics[width = \textwidth]{Figs/TS-plots/TSplots-INC-EXP.pdf}
	\includegraphics[width = \textwidth]{TSplots-INC-EXP.pdf}
...
%	\includegraphics[width=\textwidth]{Figs/Results/NaiveVsBase_MSE.pdf}
	\includegraphics[width=\textwidth]{NaiveVsBase_MSE.pdf}
...
%	\includegraphics[width=\textwidth]{Figs/Results/PointF_MSE.pdf}
	\includegraphics[width=\textwidth]{PointF_MSE.pdf}
...
%	\includegraphics[width=\textwidth]{Figs/Results/PointF_MASE.pdf}
	\includegraphics[width=\textwidth]{PointF_MASE.pdf}
...
%	\includegraphics[width=\textwidth]{Figs/Results/ProbF_MultivS.pdf}
	\includegraphics[width=\textwidth]{ProbF_MultivS.pdf}
...
%	\includegraphics[width=\textwidth]{Figs/Results/ProbF_UnivS.pdf}
	\includegraphics[width=\textwidth]{ProbF_UnivS.pdf}
