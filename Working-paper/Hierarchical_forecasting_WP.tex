...
\usepackage{monashwp}
\usepackage{amssymb, qtree, bm, multirow, textcmds, siunitx, mathrsfs, float, booktabs,sidenotes}
\usepackage[bb=boondox]{mathalfa}
\usepackage{tikz}
\usepackage{tikz}
\definecolor{hfill_blue}{RGB}{208,229,249}
\definecolor{hfill_yellow}{RGB}{255,255,208}
\usetikzlibrary{trees,shapes,arrows,positioning,shapes,fit,calc}
...
\addresses{\textbf{George Athanasopoulos}\\
	Department of Econometrics and Business Statistics,\\
	Monash University,\\ VIC 3800, Australia.\\
	Email: George.Athanasopoulos@monash.edu\\[1cm]
	\textbf{Puwasala Gamakumara}\\
	Department of Econometrics and Business Statistics,\\
  	Monash University,\\ VIC 3800, Australia.\\
  	...
  	\textbf{Mohamed Affan}\\
  	Email: affan.momu@gmail.com}

\lfoot{\sf Athanasopoulos, Gamakumara, Panagiotelis, Hyndman, \& Affan: \today}
